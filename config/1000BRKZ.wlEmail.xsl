...
<xsl:if test="Type = 'FXSpotFwd' or Type = 'FXFwdFwd'">
    ...
    <tr>
	  ...
	  <td style="color: #000066;">: <xsl:value-of select="OrderNotes"/></td>
    	...
    	<p>If you have any questions regarding this email, please contact the Access 1000BRKZ FX Team.</p>
   	<p style="color: #666;"><b>Access 1000BRKZ FX Support</b><br />
   	 Email: <a href="mailto:support@1000BRKZ.com">support@1000BRKZ.com </a><br />

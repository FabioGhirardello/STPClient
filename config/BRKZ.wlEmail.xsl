...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/STPMessage">
        ...
        <body style="font-family:Verdana; font-size: 11px; margin-left: 50px; margin-top: 25px;">
            ...
            <p>If you have any questions regarding this email, please contact the BRKZ FX Team.</p>
            <p style="color: #666;"><b>BRKZ FX Support</b><br />
                Email: <a href="mailto:support@integral.com">support@BRKZ.com </a><br />
